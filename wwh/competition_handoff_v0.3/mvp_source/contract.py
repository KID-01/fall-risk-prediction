...
def default_config() -> dict[str, Any]:
    return {
        ...
        "risk_extensions": {
            # v0.3 optional extensions. Default off keeps v0.2 behavior and output schema.
            "enabled": False,
            "lighting": {
                "dark_pixel": 45,
                "mean_dark": 70.0,
            ...
            "clutter": {
                "obstacle_classes": ["chair", "dining table", "backpack", "suitcase", "sports ball"],
            ...
            "trajectory": {
                ...
                "horizon_s": 1.0,
                "steps": 6,
                "moving_speed_px_s": 8.0,
                "speed_scale_px_s": 100.0,
            },
            "interaction": {
                "obstacle_classes": ["chair", "dining table", "backpack", "suitcase", "sports ball"],
                "corridor_radius_px": 24.0,
            },
            "wet_floor": {
                "enabled": False,
